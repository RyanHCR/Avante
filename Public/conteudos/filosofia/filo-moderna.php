...
<br><br>
    ...
    <img class="image-center" src="../../../Resources/images/moderna2.jpeg">
    
<div class="box50">
    <p class="text2">Este período está intimamente ligado ao surgimento da ciência moderna, ao humanismo e às mudanças sociais, políticas e econômicas que ocorreram na Europa.</p>
</div>
<div class="box2">
    <p class="text4">PRINCIPAIS FILÓSOFOS DA FILOSOFIA MODERNA:</p>
    </div>
    <br><br>
    ...
    <div class="custom-box-container">
        <div class="custom-box custom-box1">
            ...
            <p class="text5">René Descartes (1596–1650):</p>
            <div class="textodaora">
        ...
        <div class="custom-box custom-box2">
         ...
         <p class="text6">John Locke (1632–1704):</p>
            <div class="textodaora">
    ...
    <li>Suas ideias sobre governo e direitos naturais (vida, liberdade e propriedade) influenciaram a teoria política moderna, especialmente no que tange ao liberalismo e ao constitucionalismo.</li>
        ...
        <p class="text7">Immanuel Kant (1724–1804):</p>
            <div class="textodaora">
    ...
    <li>Desenvolveu a teoria do idealismo transcendental, segundo a qual o tempo, o espaço e as categorias do entendimento não são propriedades do mundo em si, mas formas pelas quais o sujeito apreende a realidade.</li>
        ...
        <p class="text8">Karl Marx (1818–1883):</p>
            <div class="textodaora">
    ...
    <div class="container">
    <div class="caixa1"><p class="textoincrivel">Esses filósofos moldaram não apenas a</p></div>
    <div class="caixa1"><p class="textoincrivel">filosofia moderna, mas também influenciaram</p></div>
    <div class="caixa1"><p class="textoincrivel">áreas como política, ciência, ética e cultura,</p></div>
    <div class="caixa1"><p class="textoincrivel">tornando-se pilares do pensamento ocidental</p></div>
</div>
