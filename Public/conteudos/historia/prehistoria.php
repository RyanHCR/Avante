...
<header class="header">
    ...
    <div class="box1">
    <p class="text1">A Pré-História foi o período do surgimento e desenvolvimento dos primeiros humanos na Terra. Para sobreviver às intemperes da natureza, eles tiveram que se adaptar ao meio ambiente. Esses grupos eram caçadores, pescadores e coletores, alimentando-se daquilo que estava disponível na natureza.</p>
    </div>
    <div class="seila">
    <img class="image1" src="../../../Resources/images/pre-hist1.jpeg">

<div class="text2"><p>A Pré-História é, basicamente, dividida entre Paleolítico, Mesolítico (período intermediário) e Neolítico. Nesses períodos, acompanhamos o desenvolvimento dos hominídeos com a elaboração de novas ferramentas, além do surgimento do homo sapiens sapiens, há cerca de 300 mil anos.</p></div>
<div class="vertical-line1"></div>
</div>
<div class="vertical-line2"></div>

<div class="box2">
    <p class="text3">Paleolítico (Idade da Pedra Lascada)<br>
    & Mesolítico (Idade da Pedra Média)
    </p>
</div>
<div class="seila">

<div class="text4"><p><li>Período: Aproximadamente 2,5 milhões a.C. a 10.000 a.C.<br>
<li>Características: É a fase mais longa da pré-história. Os seres humanos eram caçadores e coletores, utilizando ferramentas de pedra lascada. A arte rupestre, como as pinturas nas cavernas de Lascaux e Altamira, e as primeiras esculturas, como a Vênus de Willendorf, datam desse período.</p></div>
<img class="image2" src="../../../Resources/images/periodo-paleolitico1.jpg">
</div>

    <div class="seila">
    <img class="image1" src="../../../Resources/images/mesolitico.png">
<div class="text2"><p class="text100">Período: Aproximadamente 10.000 a.C. a 5.000 a.C.
Características: Este período é uma fase de transição entre o Paleolítico e o Neolítico. A caça e a coleta continuaram, mas houve um aumento na utilização de pequenas ferramentas de pedra polida, e o início de um estilo de vida mais sedentário. Algumas culturas começaram a desenvolver técnicas primitivas de agricultura.</p></div>
<div class="vertical-line1"></div>
</div>
<div class="vertical-line2"></div>

<div class="box2">
    <p class="text5">Neolítico (Idade da Pedra Polida)</p>
</div>
<div class="seila">

<div class="text4"><p class="text100">Período: Aproximadamente 5.000 a.C. a 3.000 a.C.
