...
<head class="body"> 
    ...
    <p>AS FORMAS DE PODER</p>
    <p>O poder assume diversas formas, que podem ser classificadas de acordo com seus meios de ação e efeitos sociais:</p>
    ...
    <p>O ESTADO: ORIGENS E DEINIÇÕES</p>
    <p>O Estado é uma entidade que exerce o poder sobre um determinado território e população. Ele possui três elementos básicos: território, governo e população, e sua função é organizar e regular as relações dentro da sociedade, impondo a ordem e provendo o bem-estar público.</p>

    <p>Contratualismo</p>
    <p>Pensadores como Thomas Hobbes, John Locke e Jean-Jacques Rousseau propuseram que o Estado surge de um contrato social, onde os indivíduos cedem parte de sua liberdade em troca de proteção e ordem.</p>

    <p>Estado Moderno:</p>
    <p>O Estado como o conhecemos hoje se consolidou a partir do fim da Idade Média, com o advento do absolutismo e, posteriormente, do Estado-Nação, após a Paz de Westfália (1648).</p>

    <p>FUNÇÕES DO ESTADO</p>
    ...
    <p>FORMAS DE ESTADO:</p>
    <p>1. Estado Democrático: Baseado na soberania popular, com participação direta ou indireta dos cidadãos (ex.: repúblicas e monarquias parlamentares).</p>
    <p>2. Estado Autoritário: Controle concentrado nas mãos de um líder ou grupo, com pouca ou nenhuma participação popular.</p>
    <p>3. Estado Totalitário: Controle absoluto sobre todas as esferas da vida social, política e econômica.</p>

    <p>O QUE É POLÍTICA?</p>
